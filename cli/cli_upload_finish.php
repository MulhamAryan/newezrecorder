<?php
    ...
    if(!$ok) {
        ...
        $logger->log(EventType::RECORDER_UPLOAD_TO_EZCAST, LogLevel::INFO, "Local asset moved from " . $config["upload_to_server"] . " to " . $config["upload_ok"] . " dir", array(basename(__FILE__)), $asset);
        return true;
    }
?>