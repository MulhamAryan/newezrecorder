...
$CFG->dbname    = 'moodle_old';     // database name, eg moodle
$CFG->dbuser    = 'moodle';   // your database username
$CFG->dbpass    = 'moodleP@ss';   // your database password
...
$CFG->wwwroot   = 'https://bib23.ulb.ac.be/old';
...
$CFG->dataroot  = '/data/moodledata_old';
...
$CFG->defaultblocks_override = ':settings,navigation,news_items,calendar_upcoming,globalsearch,progress';
//
...
$CFG->session_file_save_path = '/var/www/old/moodlesessions';
//
...
$CFG->customscripts = '/data-vg0/moodle_old/local/customize/';
//
...
//
$CFG->tempdir = '/var/www/old/moodletemp';        // Files used during one HTTP request only.
//     $CFG->cachedir = '/var/www/moodle/cache';      // Directory MUST BE SHARED by all cluster nodes, locking required.
$CFG->localcachedir = '/var/www/old/moodlelocalcache';      // Intended for local node caching.
//
...
// When the Moodle site is being upgraded as a result of the Moodle core update and/or a plugin installation/update,
// no authentication and authorization mechanisms are reliable. Any anonymous visitor of your site can potentially
// trigger the upgrade process by navigating their browser to your admin page. This can be seen as a security risk
// because a lot of sensitive information (server environment, plugin versions etc) are available at the upgrade
// screens.

$CFG->upgradekey = 'UV-Upgrade-Key';
